...
This project is a simple web application that generates a random Pokémon card using the Pokémon API.
Each generated card displays an image of a random Pokémon along with its name and type(s).
